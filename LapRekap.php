...
<head>
	...
	<title>Koperasi | Laporan Rekap</title>  
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse pull-left" id="navbar-collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="LapRekap.php"><i class="fa fa-files-o"></i> Laporan Rekap</a></li>
	...
	<div class="content-wrapper">
		<div class="container">
			<section class="content-header">
				<h2>
				<i class="fa fa-files-o"></i> Laporan Rekap Simpanan
				<button type="button" class="btn btn-info pull-right" id="print" onclick="window.location='printRekap.php'" style="border-radius: 100px;padding-left: 25px;padding-right: 25px"><i class="fa fa-print"></i> Print</button>
				</h2>
					<?php
					echo "<h4><i class='fa fa-users'></i> Total Anggota Keseluruhan : <b>".$totalAnggota = mysql_num_rows(mysql_query("SELECT * FROM user"))."</b></h4>";
					?>
			</section>
			<section class="content">
				...
				<div class="box-header">
					<?php
					$qtotsimpan = mysql_query("SELECT SUM(nominal) FROM simpan");
					$rtotsimpan = mysql_fetch_array($qtotsimpan);
					$qtottarik = mysql_query("SELECT SUM(nominal) FROM tarik");
				...
				<div class="box-body">
					<table id="tbl_rekap" class="table table-condensed table-striped table-hovered">
						<thead>
							<tr>
								<th>#</th>
